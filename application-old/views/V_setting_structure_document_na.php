						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">	
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="cursor:pointer">
								...
								<tbody id="1">
									...
									$is_continue = true;
									$no = 1;
									$get_data = $this->M_admin_setting->GET_STRUKTUR_DOKUMEN_ALL_NA();
									...
									<tr>
										...
										<td style="text-align:center;"><a class="btn-link fa fa-refresh" href="<?=base_url('C_setting_structure_document/enable/'.$data_row->DTSETE_ID);?>" style="color:black;"></a></td>
									</tr>
									<?php
									 $no++;
										}
	...
	<script type="text/javascript">
		jQuery(function($) {
			$('#activega').change(function(){
				...
				if (activega == '1') {
					window.location.href = '<?= base_url("C_setting_structure_document"); ?>';
				}
			});
