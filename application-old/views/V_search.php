							...
							<div id="accordion" class="accordion-style1 panel-group">
								<form class="form-horizontal" id="form_search" name="form_search" action="<?php echo base_url('search'); ?>" method="POST">
									<div class="input-group">
										...
										<input type="text" id="keyword" name="keyword" class="form-control" placeholder="Search (Write A Keyword)" value="<?= set_value('keyword') ?>" required autocomplete="off" />
							...
							<tbody>
								<tr>
									...
									<td>
										...
										<?php if (strrpos($detail[$i][0]->JBLL_DOWNLOAD, $SESSION_JOB_LEVEL_ID) !== FALSE): ?>
