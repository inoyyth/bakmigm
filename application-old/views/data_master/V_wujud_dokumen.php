...
<body class="no-skin">
					...
					<div class="row">
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="cursor:pointer">
							...
							<tbody>
								...
								$is_continue = true;
								$no = 1;
								$get_data = $this->M_admin_setting->GET_WUJUD_DOKUMEN();
								...
								?>
								<tr data-toggle="modal" data-target="#modal-edit<?= $data_row->DTFM_ID; ?>">
									<td><?= $no; ?></td>
									<td><?php echo $data_row->DTFM_ID; ?></td>
									<td><?php echo $data_row->DTFM_NAME; ?></td>
								</tr>
								<?php
								 $no++;
									}
	...
	<!-- MODAL VIEW EDIT -->
	<?php
		$view = $this->M_admin_setting->GET_WUJUD_DOKUMEN();
		foreach ($view as $view):
	?>
	<div id="modal-edit<?= $view->DTFM_ID ?>" class="modal" tabindex="-1">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body" style="margin: 0 15px">
					<div class="row">
						<input type="hidden" name="tipe" value="Wujud Dokumen Master">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<div class="form-group">
								<label for="id">ID :</label>
								<input readonly type="text" name="id" id="id" class="form-control" value="<?= $view->DTFM_ID; ?>">
							</div>
							<div class="form-group">
								<label for="nama">Nama :</label>
								<input type="text" name="nama" id="nama" class="form-control" value="<?= $view->DTFM_NAME; ?>" required>
							</div>
						</div><!-- col -->
					</div><!-- row -->
				</div><!-- body -->
				<div class="modal-footer">
					<a href="<?= base_url('C_setting_data_master/delete/WD/'.$view->DTFM_ID); ?>" class="btn btn-danger btn-sm" style="float:left;">Hapus</a>
