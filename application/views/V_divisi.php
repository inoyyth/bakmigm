<div class="row">
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="cursor:pointer">
		...
		<tbody>
			...
			$is_continue = true;
			$no = 1;
			$get_data = $this->M_admin_setting->GET_DIVISI_ALL();
			...
			?>
			<tr data-toggle="modal" data-target="#modal-edit<?= $data_row->DI_ID; ?>">
				<td><?= $no ?></td>
				<td><?php echo $data_row->DI_CODE; ?></td>
				<td><?php echo $data_row->DI_NAME; ?></td>
				<td><?php echo $data_row->DT_NAME; ?></td>
...
<!-- MODAL VIEW EDIT -->
<?php
		$view = $this->M_admin_setting->GET_DIVISI_ALL();
		foreach ($view as $view):
	?>
	<div id="modal-edit<?= $view->DI_ID ?>" class="modal" tabindex="-1">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="blue bigger">Lihat Data</h5>
				</div>
				<form method="POST" action="<?= base_url('C_setting_structure_organization/update_divisi') ?>" class="form-horizontal">
				<div class="modal-body" style="margin: 0 15px">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<div class="form-group">
								<label for="id">ID Divisi :</label>
								<input type="text" name="id" id="id" class="form-control" value="<?= $view->DI_ID; ?>">
							</div>
							<div class="form-group">
								<label for="code">Code Divisi :</label>
								<input type="text" name="code" id="code" class="form-control" value="<?= $view->DI_CODE; ?>" required>
							</div>
							<div class="form-group">
								<label for="nama">Nama Divisi :</label>
								<input type="text" name="nama" id="nama" class="form-control" value="<?= $view->DI_NAME; ?>" required>
							</div>
							<div class="form-group">
								<label for="level">Level :</label>
								<input type="text" name="level" id="level" class="form-control" value="02 - Divisi" required>
							</div>
							<div class="form-group">
								<label for="parent">Parent :</label>
								<input type="text" class="form-control" value="<?= $view->DT_NAME; ?>">
							</div>
						</div><!-- col -->
					</div><!-- row -->
				</div><!-- body -->
				<div class="modal-footer">
					<button type="button" data-dismiss="modal" class="btn btn-warning btn-sm" style="float:right;">Close</button>
				</div><!-- footer -->
				</form>
			</div>
		</div>
