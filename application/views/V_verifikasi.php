							...
							<div id="login-box" class="login-box visible widget-box no-border" style="margin-top: 100px;">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form id="form_login" name="form_login" action="<?php echo base_url('C_index/verifikasi'); ?>" method="post">
											<fieldset>
												<div class="space"></div>
												<div class="space"></div>
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														<input type="text" id="si_userid" name="si_userid" class="form-control" placeholder="6 Digit kode verifikasi" required/>
