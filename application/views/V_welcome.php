			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="row">
						<div class="center">
							<p class="lead">
								Halo <?php echo $SESSION_NAME; ?>, Selamat Datang di eDokumen Web Portal BakmiGM
							</p>
							<ul class="list-unstyled spaced">
								<li>
									<h1 style="font-size:80px;">
										<img width="200" src="<?php echo base_url('template/backend/assets/images/avatars/logo_big.png'); ?>"> e-Dokumen
									</h1>
								</li>
							</ul>
						</div>
