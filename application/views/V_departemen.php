...
<body class="no-skin">
					...
					<div class="row">
						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="cursor:pointer">
							...
							<tbody>
								...
								$is_continue = true;
								$no = 1;
								$get_data = $this->M_admin_setting->GET_DEPT_DIVISI_ALL();
								...
								?>
								<tr data-toggle="modal" data-target="#modal-edit<?= $data_row->DN_ID; ?>">
									<td><?= $no ?></td>
	...
	<!-- MODAL VIEW EDIT -->
	<?php
		$view = $this->M_admin_setting->GET_DEPT_DIVISI_ALL();
		foreach ($view as $view):
	?>
	<div id="modal-edit<?= $view->DN_ID ?>" class="modal" tabindex="-1">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<div class="form-group">
								<label for="id">ID Departemen :</label>
								<input type="text" name="id" id="id" class="form-control" value="<?= $view->DN_ID; ?>">
							</div>
							<div class="form-group">
								<label for="code">Code Departemen :</label>
								<input type="text" name="code" id="code" class="form-control" value="<?= $view->DN_CODE; ?>" required>
							</div>
							<div class="form-group">
								<label for="nama">Nama Departemen :</label>
								<input type="text" name="nama" id="nama" class="form-control" value="<?= $view->DN_NAME; ?>" required>
							</div>
							<div class="form-group">
								<label for="level">Level :</label>
								<input type="text" name="level" id="level" class="form-control" value="03 - Departemen" required>
							</div>
							<div class="form-group">
								<label for="parent">Parent :</label>
								<input type="text" class="form-control" value="<?= $view->DI_CODE; ?>">
							</div>
						</div><!-- col -->
					</div><!-- row -->
				</div><!-- body -->
