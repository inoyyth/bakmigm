<div class="row">
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="cursor:pointer">
		...
		<tbody>
			...
			$is_continue = true;
			$no = 1;
			$get_data = $this->M_admin_setting->GET_PROSES();
			...
			?>
			<tr data-toggle="modal" data-target="#modal-edit<?= $data_row->PROSES_ID; ?>">
				<td><?= $no; ?></td>
				<td><?php echo $data_row->PROSES_ID; ?></td>
				<td><?php echo $data_row->PROSES_NAME; ?></td>
			</tr>
			<?php
				$no++;
				}
...
<!-- MODAL VIEW EDIT -->
<?php
		$view = $this->M_admin_setting->GET_PROSES();
		foreach ($view as $view):
	?>
	<div id="modal-edit<?= $view->PROSES_ID ?>" class="modal" tabindex="-1">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body" style="margin: 0 15px">
					<div class="row">
						<input type="hidden" name="tipe" value="Proses">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
							<div class="form-group">
								<label for="id">ID :</label>
								<input readonly type="text" name="id" id="id" class="form-control" value="<?= $view->PROSES_ID; ?>">
							</div>
							<div class="form-group">
								<label for="nama">Nama :</label>
								<input type="text" name="nama" id="nama" class="form-control" value="<?= $view->PROSES_NAME; ?>" required>
							</div>
						</div><!-- col -->
					</div><!-- row -->
				</div><!-- body -->
				<div class="modal-footer">
					<a href="<?= base_url('C_setting_data_master/delete/Proses/'.$view->PROSES_ID); ?>" class="btn btn-danger btn-sm" style="float:left;">Hapus</a>
