										...
										<div class="widget-main padding-8">
											...
											<div id="profile-feed-1" class="profile-feed">
												<?php
													$si_key = $this->input->post('si_key');
													$si_key = $si_key[0];
													$get_data_comment = $this->M_library_database->DB_GET_DATA_DOCUMENT_COMMENT_BY_AUTHOR($this->session->userdata("session_bgm_edocument_id"),$si_key);
												...
												?>
														<div class="profile-activity clearfix">
															<div>
																...
																<a class="user"> <?php echo $data_row->FULL_NAME; ?> </a>
																<div>
																	<p>
																		<table width="100%">
																			<tr>
