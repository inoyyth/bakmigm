					...
					<div class="row" id="table">
						<table id="example" class="table table-bordered table-striped table-hovered example">
							...
							for ($i=0; $i < $jml; $i++):
								...
								$DOC_DATE_EXPIRED = date('Y-m-d',strtotime($detail[0][$i]->DOC_TGL_EXPIRED));
							...
							<tbody>
								<tr>
									<td><?php echo $detail[0][$i]->DOC_NOMOR;?></td>
									<td><?php echo $detail[0][$i]->DOC_NAMA;?></td>
									<td><?php echo $detail[0][$i]->DTSETE_SINGKATAN;?></td>
									<td><?php echo $detail[0][$i]->DN_CODE;?></td>
									<td><?php echo date('d/M/Y', strtotime($detail[0][$i]->DOC_DATE));?></td>
									<td><?php echo $detail[0][$i]->DOC_STATUS;?></td>
									<td><?php echo $aging;?></td>
									<td>
										<a href="<?php echo base_url('document-details-'.$detail[0][$i]->DOC_ID); ?>" class="fa fa-eye" style="font-size: 2rem;text-decoration: none;color: black;" target="_blank"></a>
										<?php if (strrpos($detail[0][$i]->JBLL_DOWNLOAD, $SESSION_JOB_LEVEL_ID) !== FALSE): ?>
										<a style="font-size: 2rem;text-decoration: none;color: black;" class="fa fa-download" href="<?=base_url('download-'.$detail[0][$i]->DOC_ID.".zip");?>" id="btn-unduh" class="btn btn-sm btn-warning"></a>
										<?php endif; ?>
									</td>
								</tr>
							</tbody>
