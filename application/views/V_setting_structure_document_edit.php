				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">	
							...
							<!-- Kategori -->
							<form id="form-kategori" method="POST" action="<?= base_url('C_setting_structure_document/edit_kategori'); ?>" class="form-horizontal hide">
								<div class="form-group">
									<label for="kode_kategori">Kode Kategori Dokumen :</label>
									<input type="text" name="kode" id="kode_kategori" class="form-control" value="<?= $DTSEKI_ID; ?>" readonly required>
								</div>
								<div class="form-group">
									<label for="nama_kategori">Nama Kategori Dokumen :</label>
									<input type="text" name="nama" id="nama_kategori" class="form-control" required value="<?= $DTSEKI_KATEGORI ?>">
								</div>
							</form>
							<!-- END Kategori -->
							<!-- jenis -->
							<form id="form-jenis" method="POST" action="<?= base_url('C_setting_structure_document/edit_jenis'); ?>" class="form-horizontal hide">
								<div class="form-group">
									<label for="kode_jenis">Kode Jenis Dokumen :</label>
									<input type="text" name="kode" id="kode_jenis" class="form-control" readonly required value="<?= $DTSEJS_ID; ?>">
								</div>
								<div class="form-group">
									<label for="nama_jenis">Nama Jenis Dokumen :</label>
									<input type="text" name="nama" id="nama_jenis" class="form-control" required value="<?= $DTSEJS_JENIS ?>">
								</div>
								<div class="form-group">
							...
							<!-- END jenis -->
							<!-- tipe -->
							<form id="form-tipe" method="POST" action="<?= base_url('C_setting_structure_document/edit_tipe'); ?>" class="form-horizontal hide">
								<div class="form-group">
									<label for="kode_tipe">Kode Tipe Dokumen :</label>
									<input type="text" name="kode" id="kode_tipe" class="form-control" required readonly value="<?= $DTSETE_ID; ?>">
								</div>
								<div class="form-group">
									<label for="nama_tipe">Nama Tipe Dokumen :</label>
									<input type="text" name="nama" id="nama_tipe" class="form-control" required value="<?= $DTSETE_TIPE; ?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" name="watermark" id="watermark" class="form-control" required value="<?= $WATERMARK ?>">
								</div>
							</form>
							<!-- END tipe -->
