...
?>
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Level
                                    Akses</label>
                                <div class="col-sm-12">
                                    <textarea type="text" rows="10" class="form-control"
                                        style="resize:none"><?=$DOC_AKSES_LEVEL_FINAL;?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Pengguna Dokumen
                                    (Dept)</label>
                                <div class="col-sm-12">
                                    <textarea type="text" rows="10" class="form-control"
                                        style="resize:none"><?=$DOC_PENGGUNA_FINAL;?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Kategori
                                    Dokumen</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Jenis
                                    Dokumen</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea rows="3" class="form-control"
                                        style="resize:none"><?=$DOC_ABSTRAK?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Departemen Pemilik
                                    Proses</label>
                                <div class="col-sm-12">
                                    <textarea type="text" rows="3" class="form-control"
                                        style="resize:none"><?=$DOC_PEMILIK_PROSES_FINAL;?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Divisi/Departemen
                                    Penyimpan</label>
                                <div class="col-sm-12">
                                    <textarea type="text" rows="3" class="form-control"
                                        style="resize:none"><?=$DOC_PENYIMPAN_FINAL;?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Divisi/Departemen
                                ...
                                <div class="col-sm-12">
                                    <textarea type="text" rows="3" class="form-control"
                                        style="resize:none"><?=$DOC_PENDISTRIBUSI_FINAL;?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Tanggal Efektif
                                    Berlaku</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control"
                                        value="<?=date('d/M/Y', strtotime($DOC_TGL_EFEKTIF));?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Periode
                                    Review</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control"
                                        value="<?=date('d/M/Y', strtotime($DOC_TGL_EXPIRED));?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Wujud
                                    Dokumen</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="" class="col-sm-12 control-label" style="text-align:left">Metode
                                    Distribusi</label>
                                <div class="col-sm-12">
...
?>
                                <div class="col-sm-6" style="margin-top:20px;">
                                    <form id="form_approve[]" name="form_approve[]"
                                        action="<?php echo base_url('C_notification/approve'); ?>" method="post"
                                        enctype="multipart/form-data">
                                        <input type="hidden" id="si_key[]" name="si_key[]"
                                            value="<?php echo $DOC_NUMBER; ?>" class="form-control" required />
                                        <input type="hidden" id="si_approver" name="si_approver" class="form-control"
                                            value="<?=$SESSION_ROLES;?>">
                                        <button type="submit"
                                            class="ace-icon fa fa-check btn btn-sm btn-primary">Terima</button>
                                        <a data-toggle="modal" data-target="#modal-reject<?=$DOC_NUMBER;?>"
                                            class="ace-icon fa fa-ban btn btn-sm btn-danger" data-popup="tooltip"
                                            data-placement="top" title="Reject">Tolak Sirkulasi</a>
                                    </form>
                                </div>
                                <?php endif;?>
                            </div>
    ...
    <div id="modal-reject<?=$DOC_NUMBER;?>" class="modal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" action="<?php echo base_url('C_notification/reject'); ?>" method="post"
                    enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-12 control-label" style="text-align:left">Catatan Untuk
                                    Diperhatikan</label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-12 control-label" style="text-align:left">Maksimum 400
                                    Karakter</label>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <input type="hidden" id="si_key" name="si_key" class="form-control"
                                        value="<?=$DOC_NUMBER;?>">
                                    <input type="hidden" id="si_approver" name="si_approver" class="form-control"
                                        value="<?=$SESSION_ROLES;?>">
                                    <textarea required type="text" id="si_note" name="si_note" rows="3" maxlength="400"
